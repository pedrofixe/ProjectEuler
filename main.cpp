...
std::string inttoroman(int input)
{
	...
	if (input >= 1000)
		return "M" + inttoroman(input - 1000);
	if (input >= 500)
		return "D" + inttoroman(input - 500);
	if (input >= 100)
		return "C" + inttoroman(input - 100);
	if (input >= 50)
		return "L" + inttoroman(input - 50);
	if (input >= 10)
		return "X" + inttoroman(input - 10);
	if (input >= 5)
		return "V" + inttoroman(input - 5);
	if (input >= 1)
		return "I" + inttoroman(input - 1);
	if (input < 1)
		return "";
}
